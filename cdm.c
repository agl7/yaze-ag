/* cdm - CP/M Disk Manager version 1.11
...
main(int argc, char **argv)
{
    ...
    puts("\nCP/M Disk Manager " VERSION
	 ...
	 "Modified by Andreas Gerlich Jan 2004 to create files for CP/M 3.1 "
	 "(yaze-ag).\n"
